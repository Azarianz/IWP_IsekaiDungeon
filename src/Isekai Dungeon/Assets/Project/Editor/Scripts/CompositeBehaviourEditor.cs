...
public class CompositeBehaviourEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < cb.behaviours.Length; i++)
            {
                ...
                cb.behaviours[i] = (FlockBehavior)EditorGUILayout.ObjectField(cb.behaviours[i], typeof(FlockBehavior), false, GUILayout.MinWidth(20f));
    ...
    void AddBehaviour(CompositeBehaviour cb)
    {
        ...
        FlockBehavior[] newBehaviours = new FlockBehavior[oldCount + 1];
        ...
        newWeights[oldCount] = 1f;  //Latest added default weight = 1
